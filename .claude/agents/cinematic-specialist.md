...
5. **Polymorphic SO catalogues** — five extension surfaces, all `ScriptableObject`-based:
   ...
   - `RoleSelectorSO` (Phase 1 ships 4: `TriggeringPlayer`, `OtherParticipant`, `CharacterByName`, `PartyMember`. Phase 2 adds archetype-based: `SpecificCharacter`, `NearestArchetype`, `RandomInRadius`.)
