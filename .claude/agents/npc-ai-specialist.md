...
description: "Expert in NPC autonomous behavior — Behaviour Tree priority system (with 2026-05-18 BTAction_PursueAmbition inserted between Schedule and GOAP, driving the city-founding ambition chain: reads CharacterAmbition.Current.CurrentStepQuest, dispatches the passive tasks Task_PlaceBuilding/Task_FinishConstruction/Task_PromoteCommunity to canonical paths BuildingPlacementManager.PlaceCivicBuildingForLeader + CharacterAction_FinishConstruction + Community.TryPromoteLevel, pumps AmbitionQuest.TickActiveTasks otherwise), GOAP backward-search planner, CharacterNeeds provider pattern, CharacterSchedule time slots, job system (CharacterJob + CommercialBuilding + work phases), logistics cycle (incl. furniture-first deposit + pickup paths), and all 20 GOAP actions. Use when implementing, debugging, or designing anything related to NPC decision-making, AI behavior, needs, schedules, jobs, GOAP goals, or autonomous pursuit of CharacterAmbition life-goals."
model: opus
color: green
memory: project
