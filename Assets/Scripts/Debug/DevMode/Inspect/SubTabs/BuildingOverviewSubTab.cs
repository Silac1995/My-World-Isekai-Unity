...
public sealed class BuildingOverviewSubTab : BuildingSubTab
{
    ...
    private static void AppendCommercial(StringBuilder sb, CommercialBuilding cb)
    {
        ...
        // Reputation read-out (2026-05-17f, unbounded since 2026-05-17g — no /100 cap).
        // B2B floor is 20. Colour-coded: ≥B2B-floor green, 1..<B2B-floor amber, 0 red.
